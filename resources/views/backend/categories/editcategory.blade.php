		...
		<div class="col-sm-4 cat-form">
			...
			<form method="post" action="{{url('updatecategory')}}/{{$singledata->cid}}">
				...
				<div class="form-group">
					...
					<p>The “slug” is the URL-friendly version of
						 the name. It is usually all lowercase and contains
				...
				<div class="form-group">
					<button class="btn btn-primary">Updat Category</button>
				</div>
			</form>	
