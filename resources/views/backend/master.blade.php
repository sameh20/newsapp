...
<head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
	...
	<link rel="stylesheet"  href="{{url('public/css/backendstyle.css')}}">	
...
<div class="sidebar">
	<ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('all-adv')}}"><i class="fa fa-eye"></i>All advertisment</a></li>
            <li><a href="{{url('add-adv')}}"><i class="fa fa-plus-circle"></i>Add Advertisment</a></li>
          </ul>
      </li>
...
<footer>
	<div class="col-sm-6">
		Copyright &copy; 2021 <a href="#">Sameh Abo Elmagd</a> All Rights Reserved. 
	</div>
	<div class="col-sm-6">
