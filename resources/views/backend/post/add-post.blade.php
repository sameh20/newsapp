          ...
          <input type="hidden" name="tbl" value="{{encrypt('posts')}}"/>
					<div class="col-sm-9">
						<div class="form-group">	
							<input type="text" name="title" class="form-control" placeholder="Enter title here" id="post-title">				
						</div>
            <div class="form-group">	
							<input type="text" name="slug" class="form-control" placeholder="Slug here" id="slug">				
						</div>							
						<div class="form-group">		
