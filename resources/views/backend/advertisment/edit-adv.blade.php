...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-10 title">
			<h1><i class="fa fa-bars"></i>Edit Advertisment</h1>
		</div>
<div class="col-sm-12">
			...
			<input type="text" name="title" class="form-control" placeholder="Enter title here" value="{{$data->title}}">				
                       ...
                       <div class="form-group">	
						...
						<div class="form-group content featured-image">
							<h4>Advertisment Image <span class="pull-right">
								<i class="fa fa-chevron-down" ></i></span></h4><hr>	
								@if($data->image !='')
						<p><img id="output"  src="{{url('public/advertisments')}}/{{$data->image}}" style="max-width: 100%"/></p>
						<p><input type="file"  accept="image/*"
							name="image" id="file"  onchange="loadFile(event)" style="display: none;"></p>
						<p><label for="file" style="cursor: pointer;" class="btn btn-warning" style="color:#fff;">Replace Image</label></p>
						@else
