...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12 title">
      <h1><i class="fa fa-bars"></i> All Advertisments <a class="btn btn-sm btn-default" href="{{url('add-adv')}}">Add New</a></h1>
    </div>
    <div class="col-sm-12">
        ...
        <table class="table table-striped" id="myTable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{$d->url}} </td>
              <td> {{$d->location}}</td>
              <td><img src="{{url('public/advertisments')}}/{{$d->image}}" width="200"></td>
              <td> {{$d->status}}</td>
              <td>{{$d->created_at}}</td>              
            </tr>    
            @endforeach                     
